...
vicon_sub = rospy.Subscriber('/publish_pose_from_tf/pose', PoseStamped, vicon_cb, queue_size=100)
odom_pub_0 = rospy.Publisher('/odometry_dummy_0', Odometry, queue_size=100)
